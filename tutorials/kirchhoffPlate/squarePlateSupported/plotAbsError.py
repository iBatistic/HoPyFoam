...
L_3 = order(grid_size, 3, error_values[0]*1.5)
L_4 = order(grid_size, 4, 180000)
plt.plot( grid_size, L_2, '--', color = "red", linewidth = 2, label='Theoretical slope - 2 order')
...
figure = plt.gcf()
figure.savefig("absErrorConvergence.png", dpi=150)
plt.close(fig)
